<template>
  <el-form :model="temp" label-position="left" label-width="50px" size="small" ref="labelForm">
    <el-form-item label="名称" class="m-input-width-80pre" :rules="[
      { required: true, message: '名称不能为空！',trigger:'blur'}
    ]">
      <el-input v-model="temp.name" @input="dataChange()" />
    </el-form-item>
    <el-form-item label="颜色" :rules="[
