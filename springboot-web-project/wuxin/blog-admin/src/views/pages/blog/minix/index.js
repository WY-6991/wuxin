...
import AddTag from "@/views/pages/blog/components/AddTag";
import AddCategory from "@/views/pages/blog/components/AddCategory";
...
export const minix = {
    ...
    data() {
      ...
      // 密码是否开启 只有开启了才会要求输入密码
        ...
        let validateTagIds = (rule, value, callback) => {
            if (value.length === 0) {
