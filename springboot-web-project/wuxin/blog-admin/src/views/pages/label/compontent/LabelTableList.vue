  ...
  >
    ...
    <el-table-column align="center" label="颜色">
      <template slot-scope="{ row }">
        <el-tag :color="row.color" size="medium "></el-tag>
      </template>
    </el-table-column>

    <el-table-column align="center" label="选项" prop="color">
      <template slot-scope="{row}">
        <el-select v-model="row.color" placeholder="请选择" @change="updateColor(row)" style="width: 230px">
          <el-option v-for="(item) in colors" :key="item" :id="item" :value="item">
