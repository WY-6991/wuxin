  ...
  <div class="image_container">
    <div v-for="image in list" :key="image.id">
      <el-popover placement="bottom" width="500" trigger="click">
        <ImageDetail :image="image" @deletePic="deletePic" :hasRoot="hasRoot" />
        <el-card slot="reference" style="cursor: pointer;margin-top: 20px;" shadow="hover">
          <el-image :src="image.url" @click="parentId = image.id" lazy alt="点击修改图片">
            <div slot="error">
...
import {minix} from "@/views/system/uplaod/component/minix";
import ImageDetail from '@/views/system/uplaod/component/ImageDetail'
