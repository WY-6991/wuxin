    ...
    <MyCard title="操作">
      ...
      <el-form ref="githubOperation" size="small" class="m-margin-tb-small" :model="github" :rules="rules">
        <el-form-item label="地址" required prop="url">
          <el-input v-model="github.url" placeholder="地址..." />
        </el-form-item>
        <el-form-item label="sha" required prop="sha">
          <el-input v-model="github.sha" placeholder="sha..." />
        </el-form-item>
        <el-form-item label="提交消息" required prop="message">
          <el-input v-model="github.message" placeholder="写点什么..." />
        </el-form-item>
        <el-form-item>
      ...
      <el-button type="text" :loading="loadingButton" size="small" class="m-float-right" @click="getData">仓库信息
      </el-button>
