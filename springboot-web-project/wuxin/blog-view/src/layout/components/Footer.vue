<template>
  <div class="ui vertical segment inverted m-flex-footer" >
    <div class="ui center aligned container footer-container">
      <div class="ui inverted divided grid m-text-padding-big" >
        ...
        <div class="five wide computer sixteen wide tablet sixteen wide mobile column m-motto-container">
      ...
      <div class="ui inverted dividing  section" >
        ...
        <div v-if="labelList.length !== 0">
          <a
            ...
            :class="lable.typeColor"
            :href="lable.url"
            :title="lable.title"
            v-for="(lable, index) in labelList"
            :key="index"
            target="_blank"
          >
            {{ lable.typeName }}
            <div class="detail" :style="{ 'background-color': lable.color }">
              {{ lable.name }}
            </div>
          </a>
        </div>
        <div v-else>
          <a
            class="ui image green label"
            href="https://vue.org.com"
            title="渐进式框架"
            target="_blank"
          >
            JS
            <div class="detail">Vue2</div>
          </a>
        </div>
      </div>
    </div>
...
<script>
import { load } from "@/utils/motto.js";
